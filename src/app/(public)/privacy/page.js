...
export async function generateMetadata() {
  ...
  return {
    title: `${category?.name || "গোপনীয়তা নীতি"} | Popular Homeo Center`,
    description: category?.description || "ওয়েবসাইটের গোপনীয়তা নীতি",
  };
}
  ...
  return (
    <div className="container">
      <div className="blog-layout">
        <div className="blog-content" id="privacy-content">
          <span className="category">{category?.name || "গোপনীয়তা নীতি"}</span>
          {article ? (
            <>
            ...
            <div style={{
              ...
              <i className="fas fa-user-shield" style={{ fontSize: "50px", color: "#cbd5e0", marginBottom: "20px" }} />
              <h2 style={{ fontSize: "1.6rem", color: "#4a5568", marginBottom: "12px", fontWeight: "600" }}>
                গোপনীয়তা নীতি শীঘ্রই আসছে
              </h2>
              <p style={{ color: "#718096", fontSize: "15px", lineHeight: "1.6", maxWidth: "460px", margin: "0 auto 24px" }}>
                আমাদের ওয়েবসাইটের গোপনীয়তা রক্ষা ও ব্যবহার সংক্রান্ত নির্দেশিকা শীঘ্রই এই পেজে যুক্ত করা হবে।
              </p>
